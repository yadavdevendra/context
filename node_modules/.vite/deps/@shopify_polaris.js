...
function Actions({
  ...
  (0, import_react510.useLayoutEffect)(() => {
    if (!actionsLayoutRef.current)
      return;
    availableWidthRef.current = actionsLayoutRef.current.offsetWidth;
...
function Collapsible({
  ...
  const startAnimation = (0, import_react571.useCallback)(() => {
...
var Text = ({
  ...
  return import_react692.default.createElement(Component9, Object.assign({
    className
  }, id ? id : null), children2);
};
